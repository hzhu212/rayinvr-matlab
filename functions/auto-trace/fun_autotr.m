% atrc.f
% old: fun_autotr(ang,layer1,iblk1,xshot,zshot,ifam,iturn,npt,iflag2,irays,nskip,idot,idr,irayps,istep)
% [npt,iflag2]
% called by: fun_auto;
% call: fun_trace; fun_vel; done.

function [npt,iflag2] = fun_autotr(ang,layer1,iblk1,xshot,zshot,ifam,iturn,irays,nskip,idot,idr,irayps,istep)
