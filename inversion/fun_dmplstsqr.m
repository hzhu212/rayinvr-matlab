function fun_dmplstsqr(pathIn,iteration)
%% 1 parameter
%% 1.1 d.in parameter

% 变量采用cell（列的形式）来保存，依次为：
% 1、属于哪个部分；
% 2、类型（III：代表整数，例如开关switch和整型数组；FFF：代表浮点数）；
% 3、英文说明；
% 4、中文说明；
...
[ncont,xm,zm,ivarz,xvel,vf,ivarv,vmodel] = fun_load_vin(ncont,xm,zm,ivarz,xvel,vf,ivarv,vmodel, path_vin_load);
